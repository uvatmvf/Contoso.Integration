...
{
    private readonly Functions.ReserveInventory _impl;
    ...
    public ReserveInventory(Microsoft.Extensions.Logging.ILogger<Contoso.InventoryFunctions.ReserveInventory> logger)
    {
        ...
        _impl = new Contoso.InventoryFunctions.Functions.ReserveInventory(new NullLogger<Functions.ReserveInventory>());
    }
